...
- Create the action class in the `com.yourcompany.yourapp.actions` package, typically extending `ViewBaseAction`
...
<controller name="Master">
    ...
    <action name="showTotal" mode="detail"
        class="com.yourcompany.yourapp.actions.ShowTotalAction"/>
</controller>
```
...
- ✅ Place action classes under `com.yourcompany.yourapp.actions`
...
- Create a `dashboards` package (e.g., `com.yourcompany.yourapp.dashboards`) and place the `Dashboard` class and its auxiliary classes in it.
